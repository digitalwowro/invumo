...
- [`development/design-qa.md`](development/design-qa.md) — the single inspected-reference design-QA log, with repository-carried hash-bound source and implementation evidence
