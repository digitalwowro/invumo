...
| Fully impersonate a non-operator User                      | Yes            | No                                              | Recent password plus throttle; no reason/separate confirmation/special timeout; target permissions/RLS and dual audit apply; Platform Operations is blocked |
