...
- Next gate: Complete Company membership/invitation/switching and named authorization primitives, then extend the tested tenant/RLS convention across the remaining Phase 1 foundations
...
- [ ] Implement and test the verification, recovery, and Company-invitation email flows using the verified foundational ZeptoMail transport.
