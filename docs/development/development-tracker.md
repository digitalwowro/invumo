...
- Next gate: Complete membership governance and ownership transfer; finish authentication/session plus verification/recovery email flows; then extend the tested tenant/RLS convention across the remaining Phase 1 foundations
...
- [ ] Implement and test the verification and recovery email flows using the verified foundational ZeptoMail transport.
...
- [ ] Implement membership role-change, removal, and leave governance.
- [ ] Implement ownership-transfer safeguards.
