    ...
    return (
        ...
        >
            {({ errors, isDirty, processing }) => {
                const actions = (
                    <FormActions align={embedded ? 'end' : 'start'}>
                        <Button
                            type="button"
                            variant="secondary"
                    ...
                    <Stack gap="lg">
                        ...
                        {rules.map((rule, index) => (
                            <div
                                ...
                                className={cn(
                                    embedded
                                        ? 'border-b border-divider pb-5 last:border-b-0 last:pb-0'
                                        : 'rounded-lg border border-divider bg-surface-inset p-4',
                                )}
                            >
                                {rule.id && (
                                    <input
