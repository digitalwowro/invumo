...
- [`architecture/role-permission-matrix.md`](architecture/role-permission-matrix.md) — draft complete Owner/Admin/Member action matrix; eight owner decisions remain open
