...
const presentations = {
    ...
    pending: { variant: 'quiet', marker: 'dot' },
    claimed: { variant: 'warning', marker: 'dot' },
    skipped: { variant: 'muted', marker: 'dot' },
    superseded: { variant: 'muted', marker: 'dot' },
    suppressed: { variant: 'muted', marker: 'dot' },
