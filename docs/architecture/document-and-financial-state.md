...
| ---------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| Create                 | First Save from an unsaved editor in an authorized Company context                                      | Persist the submitted `DRAFT` with an allocated number | Audit creation; idempotent first Save                                                             |
...
| Action              | Preconditions                                                                      | Result                                              | External/history effects                                             |
| ------------------- | ---------------------------------------------------------------------------------- | --------------------------------------------------- | -------------------------------------------------------------------- |
| Create              | First Save from an unsaved editor in an authorized Company context                 | Persist the submitted `DRAFT` with allocated number | Audit creation; idempotent first Save                                |
