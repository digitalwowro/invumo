...
return [
    ...
    'edit' => array_replace_recursive($quotes['edit'], [
        'head_title' => 'Invoice',
        'title' => 'Invoice',
        'description' => 'Build and maintain this Invoice from saved Customer, Company, and catalog values.',
        'defaults_description' => 'These values are saved specifically for this Invoice. Later source changes do not rewrite them.',
        'save' => 'Save invoice',
    ...
    'workspace' => [
        ...
        'money_tab' => 'Payments & adjustments',
        'sharing_tab' => 'Sharing & reminders',
        'line_count' => ':count products',
        'line_count_one' => '1 product',
        'amount_due' => ':amount :currency due',
        'send_email' => 'Send email',
        'send_requires_save' => 'Save the Invoice before sending it.',
        'balance' => 'Balance',
        'outstanding' => 'outstanding',
        'gross' => 'Gross',
        'discount' => 'Discount',
        ...
        'reminders' => 'Reminders',
        'reminder_count' => ':count rules',
        'reminder_count_one' => '1 rule',
