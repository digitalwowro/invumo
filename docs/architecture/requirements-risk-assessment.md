...
| --- | --- |
| Routes/navigation/editor composition | Prevent duplicated pages, inconsistent operational lists, and editor divergence before the custom shell is built |
| Upload/storage | Fix logo type/size/dimension validation, private/public visibility, serving, replacement, deletion, and backup behavior before uploads |
