...
- [x] Implement append-only audit-event infrastructure used by every later business operation, including forced RLS, restricted runtime grants, Company-scoped idempotency, and secret-shaped payload rejection.
